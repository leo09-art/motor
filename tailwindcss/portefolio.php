...
<div class="flex justify-between sticky top-0 bg-rose-700 h-[100px] w-[98vw] rounded-xl z-10">
    ...
    <p class="text-2xl">Informer vous sur la meteo avant de sortir pour eviter les surprises désagréables</p>
    <p><a href="meteo/weather.html" class="text-3xl italic text-blue-200">Meteo</a></p>
</body>
</html>